...
export const composeStructField = (prop: IProperty) => `${prop.type} ${prop.name};`;
export const composeStructFields = (props: IProperty[]) => props.map(composeStructField).join(BR + TAB);